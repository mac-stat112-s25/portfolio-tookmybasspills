...
*to make each line of code legible and easy to understand*
:::
...
A graph of Wisconsin republican counties from 2020, arranged by the highest amount of votes 
:::
...
*keeping them in that order means that any errors from filtering arent hidden by arranging them
...
BEFORE running the below chunk, what do you think it will produce?
Creates a sheet of Delaware republican counties that won in 2020, alongside the amount of support by each party

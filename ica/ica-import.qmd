...
```{r}
library(tidyverse)
imdb_messy <- read_csv("C:\\Users\\comma\\OneDrive\\Documents\\GitHub\\portfolio-tookmybasspills\\data\\imdb_5000_messy.csv")
```
...
*many NAs and that is not good no no! i would want to clean that*
...
*wether a movie is shot in black and white or color*
...
*Black and White, B&W, color, and Color*
...
*so we save it in an altered copy, and its an easier thing to do*
...
*not much changes, not getting rid of unneccesary values like drop.na on everything*

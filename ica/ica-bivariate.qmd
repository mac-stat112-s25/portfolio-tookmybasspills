...
```{r}
  plot(elections, aes(x = repub_pct_16, y = repub_pct_20))
...
While for most places republican support did not change too much from 2016 to 2020 (giving it a strong positive relationship), some counties in places like texas and utah shifted more in support of trump.
...
**support for trump was highest in historically red counties, with purple and blue counties following behind in that order.**
...
**i am a big fan of density plots have to admit**
-   What is one pro of density plots relative to boxplots?
**boxplots are very general in statistics, density plots show everything**
-   What is one con of density plots relative to boxplots?
**its tough to find medians and percentiles in density plots**
...
**it makes it very easy to see which is most popular, but it's hard to tell which is less**

#### Part b {.unnumbered}

What's your favorite bar plot from part and why?
**i do love a proportianal bar plot its very pretty**

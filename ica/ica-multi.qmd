...
The most typical outcomes are around the 900 and 1025 range, but I don't know why its like this 
...
ggplot(education, aes(x = expend, y = sat, color = fracCat)) +
  ...
  geom_smooth(se = FALSE, method = "lm")
```
these graphics show that while having less students increases the average sat score per school, spending more on schools will still result in higher averages within these groups.
#### Part d {-}
